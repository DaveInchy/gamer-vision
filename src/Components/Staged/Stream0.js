...
import { Container, Section } from '../Modules/Containers.tsz';
    ...
    useEffect(() => {
        ...
        async function handler() {
            ...
            if (status === "open") {
                ...
                let waitingForDetections = false;
                ...
                const Stream = await navigator.mediaDevices.getDisplayMedia({
                    ...
                    try {
                        ...
                        async function draw(timestamp) {
                            ...
                            if (!waitingForDetections) {

                                waitingForDetections = true;

                                await model.detect(canvas).then(boxes => {
                                    waitingForDetections = false;

                                    boxes.forEach((box, i, a) => {
                                        try {
